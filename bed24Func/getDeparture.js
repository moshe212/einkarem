...
const getDeparture = async () => {
  ...
  for (let i = 0; i < BookingList.length; i++) {
    ...
    if (isIsraeli && !isGroup && Number == "972526817788@c.us") {
      // && Number == "972523587990@c.us"
      await client.sendMessage("972526817788@c.us", textMessage1);
      await client.sendMessage("972526817788@c.us", textMessage2);
    }
  }
};
